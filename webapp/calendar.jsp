...
<div class="uk-container uk-container-large">
    <div class="uk-text-center uk-margin-large-bottom">
        <h1 class="uk-heading-medium">
            <span uk-icon="icon: calendar; ratio: 2"></span> Calendar Management
        </h1>
        <p class="uk-text-muted">Manage your service hours and special days</p>
    </div>

    <div class="uk-text-center uk-margin-bottom">
        <button class="new-calendar-btn" id="btnAddCalendar">
            <span uk-icon="plus-circle"></span> Add New Calendar
        </button>
    </div>
        ...
        <form id="createCalendarForm" class="uk-form-stacked">
            ...
            <div class="uk-margin">
                ...
                <div class="day-input-group uk-margin-small-top">
                    <div class="day-box-enhanced">
                        <label>Mon</label>
                        <div class="time-slot-container" id="newTimeSlots_mon">
                            <p class="uk-text-muted uk-text-small uk-margin-remove">No hours set</p>
                        </div>
                        <button type="button" class="uk-button uk-button-default uk-button-small btn-add-time-slot-new" data-day="mon">
                            <span uk-icon="icon: plus; ratio: 0.7"></span> Add
                        </button>
                        <input type="hidden" id="new_mon" value="">
                    </div>
                    <div class="day-box-enhanced">
                        <label>Tue</label>
                        <div class="time-slot-container" id="newTimeSlots_tue">
                            <p class="uk-text-muted uk-text-small uk-margin-remove">No hours set</p>
                        </div>
                        <button type="button" class="uk-button uk-button-default uk-button-small btn-add-time-slot-new" data-day="tue">
                            <span uk-icon="icon: plus; ratio: 0.7"></span> Add
                        </button>
                        <input type="hidden" id="new_tue" value="">
                    </div>
                    <div class="day-box-enhanced">
                        <label>Wed</label>
                        <div class="time-slot-container" id="newTimeSlots_wed">
                            <p class="uk-text-muted uk-text-small uk-margin-remove">No hours set</p>
                        </div>
                        <button type="button" class="uk-button uk-button-default uk-button-small btn-add-time-slot-new" data-day="wed">
                            <span uk-icon="icon: plus; ratio: 0.7"></span> Add
                        </button>
                        <input type="hidden" id="new_wed" value="">
                    </div>
                    <div class="day-box-enhanced">
                        <label>Thu</label>
                        <div class="time-slot-container" id="newTimeSlots_thu">
                            <p class="uk-text-muted uk-text-small uk-margin-remove">No hours set</p>
                        </div>
                        <button type="button" class="uk-button uk-button-default uk-button-small btn-add-time-slot-new" data-day="thu">
                            <span uk-icon="icon: plus; ratio: 0.7"></span> Add
                        </button>
                        <input type="hidden" id="new_thu" value="">
                    </div>
                    <div class="day-box-enhanced">
                        <label>Fri</label>
                        <div class="time-slot-container" id="newTimeSlots_fri">
                            <p class="uk-text-muted uk-text-small uk-margin-remove">No hours set</p>
                        </div>
                        <button type="button" class="uk-button uk-button-default uk-button-small btn-add-time-slot-new" data-day="fri">
                            <span uk-icon="icon: plus; ratio: 0.7"></span> Add
                        </button>
                        <input type="hidden" id="new_fri" value="">
                    </div>
                    <div class="day-box-enhanced">
                        <label>Sat</label>
                        <div class="time-slot-container" id="newTimeSlots_sat">
                            <p class="uk-text-muted uk-text-small uk-margin-remove">No hours set</p>
                        </div>
                        <button type="button" class="uk-button uk-button-default uk-button-small btn-add-time-slot-new" data-day="sat">
                            <span uk-icon="icon: plus; ratio: 0.7"></span> Add
                        </button>
                        <input type="hidden" id="new_sat" value="">
                    </div>
                    <div class="day-box-enhanced">
                        <label>Sun</label>
                        <div class="time-slot-container" id="newTimeSlots_sun">
                            <p class="uk-text-muted uk-text-small uk-margin-remove">No hours set</p>
                        </div>
                        <button type="button" class="uk-button uk-button-default uk-button-small btn-add-time-slot-new" data-day="sun">
                            <span uk-icon="icon: plus; ratio: 0.7"></span> Add
                        </button>
                        <input type="hidden" id="new_sun" value="">
                    </div>
                </div>
            </div>
            ...
            <div class="special-days-section">
                <div class="uk-flex uk-flex-between uk-flex-middle uk-margin-bottom">
                    ...
                    <button type="button" class="uk-button uk-button-secondary uk-button-small" id="btnAddNewSpecialDay">
                        <span uk-icon="plus"></span> Add Special Day
                    </button>
                </div>
                <div id="newCalendarSpecialDaysList">
                    <p class="uk-text-muted uk-text-small">No special days added yet. You can add them now or later after creating the calendar.</p>
                </div>
            </div>

            <div class="uk-margin uk-text-right">
                <button type="button" class="uk-button uk-button-default" id="btnCancelCreate">Cancel</button>
                <button type="button" class="uk-button uk-button-primary" id="btnCreateCalendar">
                    <span uk-icon="check"></span> Create Calendar
                </button>
            </div>
        </form>
    </div>
    ...
    <div id="calendarList">
        <p class="uk-text-center uk-text-muted" id="loadingMessage">
            <span uk-spinner></span> Loading calendars...
        </p>
    </div>
    ...
    <div class="uk-modal-dialog uk-modal-body">
        ...
        <form id="specialDayForm" class="uk-form-stacked">
            ...
            <div class="uk-margin uk-text-right">
                ...
                <button class="uk-button uk-button-primary" type="button" id="btnSaveSpecialDay">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.btn-add-time-slot-new').forEach(function(btn) {
            btn.addEventListener('click', function() {
                addTimeSlotForNewCalendar(this.getAttribute('data-day'));
            });
        });
    ...
    function renderCalendarList() {
        ...
        if (calendarsData.length === 0) {
            container.innerHTML = 
                '<div class="uk-text-center uk-padding">' +
                    ...
                    '<p class="uk-text-muted uk-margin-top">No calendars found. Click "Add New Calendar" to create one.</p>' +
                '</div>';
            return;
        }
        ...
        for (var i = 0; i < calendarsData.length; i++) {
            ...
            var relatedSpecialDays = specialDaysData.filter(function(sd) { 
                return sd.key && sd.key.startsWith(cal.key + '.'); 
            });
            
            html += '<li class="calendar-card">' +
                '<a class="uk-accordion-title calendar-header" href="#">' +
                    '<div class="calendar-header-content">' +
                        '<div class="calendar-header-left">' +
                            '<span uk-icon="calendar"></span> ' +
                            '<strong>' + escapeHtml(cal.key) + '</strong>' +
                            '<span class="uk-badge uk-margin-small-left">' + relatedSpecialDays.length + ' special days</span>' +
                        '</div>' +
                        '<button type="button" class="btn-delete-header btn-delete-cal-header" data-key="' + escapeHtml(cal.key) + '" onclick="event.preventDefault(); event.stopPropagation();">' +
                            '<span uk-icon="icon: trash; ratio: 0.8"></span> Delete' +
                        '</button>' +
                    '</div>' +
                '</a>' +
                '<div class="uk-accordion-content calendar-body">' +
                    renderEditForm(cal, i) +
                    renderSpecialDaysSection(cal.key, relatedSpecialDays, i) +
                '</div>' +
            '</li>';
        }
    ...
    function renderEditForm(cal, index) {
        ...
        var html = '<form id="editForm_' + index + '" class="uk-form-stacked">' +
            '<div class="uk-margin">' +
                '<label class="uk-form-label section-title">Weekly Working Hours</label>' +
                '<span class="info-text">Click "Add Time Slot" to add working hours. You can add up to 4 time slots per day.</span>' +
                '<div class="day-input-group uk-margin-small-top">';
        ...
        for (var d = 0; d < days.length; d++) {
            ...
            html += '<div class="day-box-enhanced">' +
                '<label>' + dayLabel + '</label>' +
                '<div class="time-slot-container" id="timeSlots_' + index + '_' + day + '" data-day="' + day + '" data-index="' + index + '">' +
                    renderTimeSlots(currentValue, index, day) +
                '</div>' +
                '<button type="button" class="uk-button uk-button-default uk-button-small btn-add-time-slot" data-index="' + index + '" data-day="' + day + '">' +
                    '<span uk-icon="icon: plus; ratio: 0.7"></span> Add' +
                '</button>' +
                '<input type="hidden" id="edit_' + day + '_' + index + '" value="' + escapeHtml(currentValue) + '">' +
            '</div>';
        }
        ...
        html += '</div>' +
            ...
            '<div class="uk-margin">' +
                '<label class="uk-form-label">Closed Day Message</label>' +
                '<input class="uk-input" type="text" id="edit_msg_' + index + '" value="' + escapeHtml(cal.msg_off_days || '') + '">' +
            '</div>' +
            '<div class="uk-margin">' +
                '<button type="button" class="uk-button uk-button-primary uk-button-small btn-update" data-key="' + escapeHtml(cal.key) + '" data-index="' + index + '">' +
                    '<span uk-icon="check"></span> Save Changes' +
                '</button>' +
                '<button type="button" class="uk-button uk-button-warning uk-button-small btn-reset-times" data-key="' + escapeHtml(cal.key) + '" data-index="' + index + '">' +
                    '<span uk-icon="refresh"></span> Reset Times' +
                '</button>' +
            '</div>' +
        '</form>';
    ...
    function renderTimeSlots(value, index, day) {
        if (!value || value.trim() === '') {
            return '<p class="uk-text-muted uk-text-small uk-margin-remove">No hours set (Closed)</p>';
        }
    ...
    function renderSpecialDaysSection(calKey, specialDays, index) {
        var html = '<div class="special-days-section">' +
            '<div class="uk-flex uk-flex-between uk-flex-middle uk-margin-bottom">' +
                '<h4 class="section-title uk-margin-remove"><span uk-icon="star"></span> Special Days & Holidays</h4>' +
                '<button class="uk-button uk-button-secondary uk-button-small btn-add-special" data-key="' + escapeHtml(calKey) + '">' +
                    '<span uk-icon="plus"></span> Add Special Day' +
                '</button>' +
            '</div>' +
            '<div id="specialDaysList_' + index + '">';
            ...
            for (var j = 0; j < specialDays.length; j++) {
                ...
                html += '<div class="special-day-item">' +
                    '<div>' +
                        ...
                        (sd.msg_off_days ? ' - ' + escapeHtml(sd.msg_off_days) : '') +
                        '<br><small class="uk-text-muted">Hours: ' + hourDisplay + '</small>' +
                    '</div>' +
                    '<button class="uk-button uk-button-danger uk-button-small btn-delete-special" data-key="' + escapeHtml(sd.key) + '">' +
    ...
    function attachDynamicEventListeners() {
        document.querySelectorAll('.btn-update').forEach(function(btn) {
            btn.addEventListener('click', function() {
                updateCalendar(this.getAttribute('data-key'), this.getAttribute('data-index'));
            });
        });
        
        document.querySelectorAll('.btn-delete-cal-header').forEach(function(btn) {
            btn.addEventListener('click', function(e) {
                e.preventDefault();
                e.stopPropagation();
                deleteCalendar(this.getAttribute('data-key'));
            });
        });

        document.querySelectorAll('.btn-reset-times').forEach(function(btn) {
            btn.addEventListener('click', function() {
                resetCalendarTimes(this.getAttribute('data-key'), this.getAttribute('data-index'));
            });
        });
        
        document.querySelectorAll('.btn-add-time-slot').forEach(function(btn) {
            btn.addEventListener('click', function() {
                addTimeSlot(this.getAttribute('data-index'), this.getAttribute('data-day'));
            });
        });
        
        document.querySelectorAll('.btn-remove-time-slot').forEach(function(btn) {
            btn.addEventListener('click', function() {
                removeTimeSlot(this.getAttribute('data-index'), this.getAttribute('data-day'), this.getAttribute('data-slot'));
            });
        });
        
        document.querySelectorAll('.btn-add-special').forEach(function(btn) {
            btn.addEventListener('click', function() {
                openAddSpecialDayModal(this.getAttribute('data-key'));
            });
        });
        
        document.querySelectorAll('.btn-delete-special').forEach(function(btn) {
            btn.addEventListener('click', function() {
                deleteSpecialDay(this.getAttribute('data-key'));
            });
        });
    }
    ...
    function addTimeSlot(index, day) {
        ...
        if (slots.length >= 4) {
            UIkit.notification({message: 'Maximum 4 time slots allowed per day!', status: 'warning'});
            return;
        }
    ...
    function showTimePickerModal(index, day) {
        var modalHtml = '<div id="timePickerModal" class="uk-flex-top" uk-modal>' +
            '<div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">' +
                '<button class="uk-modal-close-default" type="button" uk-close></button>' +
                '<h2 class="uk-modal-title">Add Time Slot</h2>' +
                '<div class="time-picker-row">' +
                    '<label style="min-width: 50px;">From:</label>' +
                    '<select id="tp_from_hour">' + generateHourOptions() + '</select>' +
                    '<span class="separator">:</span>' +
                    '<select id="tp_from_min">' + generateMinuteOptions() + '</select>' +
                '</div>' +
                '<div class="time-picker-row">' +
                    '<label style="min-width: 50px;">To:</label>' +
                    '<select id="tp_to_hour">' + generateHourOptions(17) + '</select>' +
                    '<span class="separator">:</span>' +
                    '<select id="tp_to_min">' + generateMinuteOptions() + '</select>' +
                '</div>' +
                '<div class="uk-margin-top uk-text-right">' +
                    '<button class="uk-button uk-button-default uk-modal-close" type="button">Cancel</button>' +
                    '<button class="uk-button uk-button-primary" type="button" id="btnConfirmTimeSlot" data-index="' + index + '" data-day="' + day + '">Add</button>' +
                '</div>' +
            '</div>' +
        '</div>';
        ...
        document.getElementById('btnConfirmTimeSlot').addEventListener('click', function() {
            ...
            if (toTotal <= fromTotal) {
                UIkit.notification({message: 'End time must be after start time!', status: 'warning'});
                return;
            }
            ...
            if (currentValue) {
                hiddenInput.value = currentValue + ' ' + timeSlot;
            } else {
            ...
            container.querySelectorAll('.btn-remove-time-slot').forEach(function(btn) {
                btn.addEventListener('click', function() {
    ...
    function showTimePickerModalForNewCalendar(day) {
        var modalHtml = '<div id="timePickerModalNew" class="uk-flex-top" uk-modal>' +
            '<div class="uk-modal-dialog uk-modal-body uk-margin-auto-vertical">' +
                '<button class="uk-modal-close-default" type="button" uk-close></button>' +
                '<h2 class="uk-modal-title">Add Time Slot</h2>' +
                '<div class="time-picker-row">' +
                    '<label style="min-width: 50px;">From:</label>' +
                    '<select id="tp_new_from_hour">' + generateHourOptions() + '</select>' +
                    '<span class="separator">:</span>' +
                    '<select id="tp_new_from_min">' + generateMinuteOptions() + '</select>' +
                '</div>' +
                '<div class="time-picker-row">' +
                    '<label style="min-width: 50px;">To:</label>' +
                    '<select id="tp_new_to_hour">' + generateHourOptions(17) + '</select>' +
                    '<span class="separator">:</span>' +
                    '<select id="tp_new_to_min">' + generateMinuteOptions() + '</select>' +
                '</div>' +
                '<div class="uk-margin-top uk-text-right">' +
                    '<button class="uk-button uk-button-default uk-modal-close" type="button">Cancel</button>' +
                    '<button class="uk-button uk-button-primary" type="button" id="btnConfirmTimeSlotNew" data-day="' + day + '">Add</button>' +
                '</div>' +
            '</div>' +
        '</div>';
    ...
    function updateNewCalendarTimeSlotDisplay(day) {
        ...
        if (!value) {
            container.innerHTML = '<p class="uk-text-muted uk-text-small uk-margin-remove">No hours set</p>';
            return;
        }
        ...
        container.querySelectorAll('.btn-remove-time-slot-new').forEach(function(btn) {
            btn.addEventListener('click', function() {
                removeTimeSlotFromNewCalendar(btn.getAttribute('data-day'), btn.getAttribute('data-slot'));
            });
        });
    }
    ...
    function showAddSpecialDayForNewCalendar() {
        ...
        if (!calendarName) {
            UIkit.notification({message: 'Please enter a calendar name first!', status: 'warning'});
            document.getElementById('new_key').focus();
            return;
        }
    ...
    function renderNewCalendarSpecialDays() {
        ...
        if (newCalendarSpecialDays.length === 0) {
            container.innerHTML = '<p class="uk-text-muted uk-text-small">No special days added yet. You can add them now or later after creating the calendar.</p>';
            return;
        }
        ...
        for (var i = 0; i < newCalendarSpecialDays.length; i++) {
            ...
            html += '<div class="special-day-item">' +
                '<div>' +
                    '<strong>' + escapeHtml(sd.date) + '</strong>' +
                    (sd.msg_off_days ? ' - ' + escapeHtml(sd.msg_off_days) : '') +
                    '<br><small class="uk-text-muted">Hours: ' + hourDisplay + '</small>' +
                '</div>' +
                '<button type="button" class="uk-button uk-button-danger uk-button-small btn-remove-new-special" data-index="' + i + '">' +
                    '<span uk-icon="trash"></span>' +
                '</button>' +
            '</div>';
        }
        ...
        document.querySelectorAll('.btn-remove-new-special').forEach(function(btn) {
            btn.addEventListener('click', function() {
                var index = parseInt(this.getAttribute('data-index'));
                newCalendarSpecialDays.splice(index, 1);
                renderNewCalendarSpecialDays();
            });
        });
    }
    ...
    function createCalendar() {
        ...
        if (!key) {
            UIkit.notification({message: 'Please enter a calendar name!', status: 'warning'});
            return;
        }

        if (key.indexOf(' ') >= 0) {
            UIkit.notification({message: 'Calendar name cannot contain spaces. Use underscore instead.', status: 'warning'});
            return;
        }

        var data = {
            key: key,
            mon: document.getElementById('new_mon').value.trim(),
            tue: document.getElementById('new_tue').value.trim(),
            wed: document.getElementById('new_wed').value.trim(),
            thu: document.getElementById('new_thu').value.trim(),
            fri: document.getElementById('new_fri').value.trim(),
            sat: document.getElementById('new_sat').value.trim(),
            sun: document.getElementById('new_sun').value.trim(),
            msg_off_days: document.getElementById('new_msg').value.trim()
        };

        fetch(API_BASE + '/serviceHours', {
            method: 'POST',
        ...
        .then(function(result) {
            if (result.success) {
                if (newCalendarSpecialDays.length > 0) {
                    saveNewCalendarSpecialDays(key);
                } else {
                    UIkit.notification({message: 'Calendar created successfully!', status: 'success'});
                    hideNewCalendarForm();
                    loadAllData();
                }
            } else {
        ...
        .catch(function(error) {
            ...
            UIkit.notification({message: 'Server connection failed!', status: 'danger'});
        });
    }
    ...
    function saveNewCalendarSpecialDays(calendarKey) {
        ...
        for (var i = 0; i < newCalendarSpecialDays.length; i++) {
            ...
            var data = {
                key: generatedKey,
                hour: sd.hour,
                msg_off_days: sd.msg_off_days
            };
            
            promises.push(
                fetch(API_BASE + '/specialDays', {
                    method: 'POST',
                    headers: {'Content-Type': 'application/json'},
                    body: JSON.stringify(data)
                })
        ...
        .then(function() {
            UIkit.notification({message: 'Calendar and special days created successfully!', status: 'success'});
            hideNewCalendarForm();
            loadAllData();
        })
        .catch(function(error) {
            console.error('Error saving special days:', error);
            UIkit.notification({message: 'Calendar created but some special days failed to save.', status: 'warning'});
            hideNewCalendarForm();
            loadAllData();
        });
    }
    ...
    function updateCalendar(key, index) {
        var data = {
            key: key,
            mon: document.getElementById('edit_mon_' + index).value.trim(),
            tue: document.getElementById('edit_tue_' + index).value.trim(),
            wed: document.getElementById('edit_wed_' + index).value.trim(),
            thu: document.getElementById('edit_thu_' + index).value.trim(),
            fri: document.getElementById('edit_fri_' + index).value.trim(),
            sat: document.getElementById('edit_sat_' + index).value.trim(),
            sun: document.getElementById('edit_sun_' + index).value.trim(),
            msg_off_days: document.getElementById('edit_msg_' + index).value.trim()
        };
        ...
        .then(function(result) {
            if (result.success) {
                UIkit.notification({message: 'Calendar updated successfully!', status: 'success'});
                loadAllData();
            } else {
                UIkit.notification({message: result.message, status: 'danger'});
            }
    ...
    function deleteCalendar(key) {
        UIkit.modal.confirm('<p>Are you sure you want to delete calendar <strong>' + key + '</strong>?</p><p class="uk-text-danger">All related special days will also be deleted!</p>').then(function() {
            fetch(API_BASE + '/serviceHours?key=' + encodeURIComponent(key), {
                method: 'DELETE'
            })
            .then(function(response) { return response.json(); })
            .then(function(result) {
                if (result.success) {
                    UIkit.notification({message: 'Calendar and related special days deleted!', status: 'success'});
                    loadAllData();
                } else {
                    UIkit.notification({message: result.message, status: 'danger'});
                }
    ...
    function saveSpecialDay() {
        ...
        .then(function(result) {
            if (result.success) {
                UIkit.notification({message: 'Special day added successfully!', status: 'success'});
                UIkit.modal('#addSpecialDayModal').hide();
                loadAllData();
            } else {
                UIkit.notification({message: result.message, status: 'danger'});
            }
    ...
    function deleteSpecialDay(key) {
        UIkit.modal.confirm('Delete special day <strong>' + key + '</strong>?').then(function() {
            fetch(API_BASE + '/specialDays?key=' + encodeURIComponent(key), {
                method: 'DELETE'
            })
            .then(function(response) { return response.json(); })
            .then(function(result) {
                if (result.success) {
                    UIkit.notification({message: 'Special day deleted!', status: 'success'});
                    loadAllData();
                } else {
                    UIkit.notification({message: result.message, status: 'danger'});
                }
