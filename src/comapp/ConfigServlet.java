...
public class ConfigServlet extends HttpServlet {
	...
	public void init(ServletConfig config) throws ServletException {
		...
		try {
			...
			try {
				SRAccessURL = sc.getResource("/META-INF/SRaccess_1.wsdl");
			...
			TrackId trackId = new TrackId("System");
			...
			GenesysUser guser = new GenesysUser(trackId.toString(), clientId, clientSecret, urlRegion);

			log.info("GenesysUser initialized for region: {}", urlRegion);
